...
"""
To do:
- Create a balance system so players can bet                        DONE
- Announce the winner                                               DONE
- Payout wins                                                       DONE
- Make a's either 1 or 11                                           DONE
- Multiple a's can be in the game                                   DONE
= Player can also have a's                                          DONE
- (optional: Same card cannot be drawm twice)
- Graphics for the cards so it will become easier to play
- Game has to end once player or dealer busts or draw BlackJack     DONE
- Split function
- Double down function
- (optional: Insurance?)
- Keep track of the wins                                            DONE
"""
